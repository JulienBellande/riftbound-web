...
const DEMO_PRODUCTS: (Omit<ShopProduct, "name" | "description"> & {
  ...
  },
  {
    ...
    nameFr: "T-shirt — Logo Riftbound",
    nameEn: "T-shirt — Riftbound Logo",
    descFr: "T-shirt 100% coton avec le logo Riftbound doré. Disponible en S, M, L, XL.",
    descEn: "100% cotton t-shirt with golden Riftbound logo. Available in S, M, L, XL.",
    priceEur: 24.99,
    priceUsd: 26.99,
    priceGbp: 21.24,
    imageUrl: null,
