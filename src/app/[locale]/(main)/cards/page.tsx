...
export default async function CardsPage({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="sticky top-12 z-30 -mx-4 mt-4 border-b border-zinc-800/50 bg-zinc-950/95 px-4 py-2 backdrop-blur-sm sm:mx-0 sm:rounded-lg sm:border sm:border-zinc-800 sm:px-3">
